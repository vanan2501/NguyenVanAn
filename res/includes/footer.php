<div class="container">
	<div class="row">
		<div class="trai col-md-5">
			<img src="<?php echo base_url('res/') ?>imgs/LearnITLogo.png" alt="" class="logo"><br><br>
		...
		<div class="phai col-md-5">
			<div class="panel panel-danger">
				...
				<div class="panel-body">
					...
					<h4><i class="glyphicon glyphicon-envelope"></i>cskh@LearnITOnline.vn</h4>
				</div>
			</div>
