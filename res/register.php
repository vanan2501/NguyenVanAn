...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="../res/imgs/icon.1png">
	<title>Đăng Ký Tài Khoản - LearnITOnline</title>
					...
					<div class="with-email">
						<form action="register" method="POST" role="form">
							...
							<div class="form-group" align="center">
								...
								<p>Bằng cách đăng nhấp vào đăng ký bạn đồng ý với <a href="dieukhoan">Điều khoản ,</a> <a href="">Quy chế hoạt động </a> và <a href="baomat">Chính sách bảo mật</a> của Edumall</p>
