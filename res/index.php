...
<head>
	...
	<link rel="shortcut icon" type="image/x-icon" href="res/imgs/icon1.png">
	<title>LearnITOnline</title>
				...
				<div class="row container">
					<div class="col-md-4">
						<section class="header-hook">
							...
							<hr>
							<p>Bạn quan tâm tới ngôn ngữ nào?</p>
						</section>
					</div>
					<div class="col-md-8">
				...
				<div class="row">
					<div class="col-md-10 col-md-offset-1">
						<div class="register-title">
							...
							<h3>để khám phá đầy đủ tính năng của LearnITOnline</h3><br><br><br>
						</div>
						...
						<div class="phai col-md-5">
							<img src="res/imgs/icon1.png" alt="LOGO Edumall">
							<div class="login">
